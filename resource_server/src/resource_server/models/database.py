...
class CacheSideEffects(EventSideEffectsTableMixin, Base):
...
class DownstreamCacheInvalidationSideEffects(EventSideEffectsTableMixin, Base):
    __tablename__ = SideEffectsTables.DOWNSTREAM_CACHE_INVALIDATION
