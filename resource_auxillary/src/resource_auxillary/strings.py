...
class EventName(StrEnum):
    ...
    DOWNSTREAM_USER_POST_DECREMENT = "DOWNSTREAM_USER_POST_DECREMENT"
    DOWNSTREAM_FORUM_POST_DECREMENT = "DOWNSTREAM_FORUM_POST_DECREMENT"
    DOWNSTREAM_USER_COMMENT_DECREMENT = "DOWNSTREAM_USER_COMMENT_DECREMENT"
    DOWNSTREAM_POST_COMMENT_DECREMENT = "DOWNSTREAM_POST_COMMENT_DECREMENT"

    DLQ_STANDARD = "DLQ_STANDARD"
    DLQ_COUNTER = "DLQ_COUNTER"
    DLQ_SIDE_EFFECTS = "DLQ_SIDE_EFFECTS"
